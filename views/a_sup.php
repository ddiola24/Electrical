                  ...
                  <!-- button -->
                    <div class="btn-toolbar">
                      <div class="btn-group">
                        ...
                        <button class="btn btn-dark" type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-lg2"> Add Suplier </button>
                        <!-- Add Product -->
                            ...
                            <div class="modal-dialog modal-lg">
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <input type="text" id="supname" class="form-control" name="supname" required />
                              ...
                              <div class="modal-footer">
                                ...
                                <button type="submit" name="submit" value="addsup" class="btn btn-primary">Save changes</button>
                              </div>
                                </form>
                                  <!-- form -->
                              </div>
